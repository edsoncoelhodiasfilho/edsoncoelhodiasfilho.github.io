...
if (quoteForm) {
  quoteForm.addEventListener("submit", () => {
    ...
    // FormSubmit receives the POST in a hidden iframe. We then navigate
    // ourselves, so its own "Thanks" page is never displayed on mobile.
    window.setTimeout(() => {
      window.location.href = "https://www.eralis.com.br/obrigado.html";
    }, 1800);
  });
}
...
if (emailForm) {
  emailForm.addEventListener("submit", () => {
    ...
    // Same strategy as the quote form, but with the email-specific
    // thank-you page.
    window.setTimeout(() => {
      window.location.href = "https://www.eralis.com.br/obrigado-email.html";
    }, 1800);
  });
}
