...
Seja bem-vindo ao meu perfil do GitHub. Sou um profissional sênior de tecnologia com **mais de 18 anos de trajetória sólida no mercado de TI voltado ao Varejo**, conectando infraestrutura de alta criticidade, banco de dados e engenharia de software para otimizar operações corporativas.
...
*   **[protheus-advpl-tlpp]([https://github.com](https://github.com/edsoncoelhodiasfilho/protheus-advpl-tlpp)):** Laboratório de códigos práticos com customizações de Pontos de Entrada, validação de regras de varejo e desenvolvimento de telas em padrão MVC e endpoints REST.
